  ...
  return (
    <div className="px-[14rem] py-[4.5rem] text-[#333333]">
      <header>
        ...
        <h2 className="uppercase text-5xl font-alumni-sans font-bold">cenro business permit processing system</h2>
      </header>
      <section>
      ...
      <section>
        <figure>
          <img className="rounded-2xl" src={CenroPic} alt="Cenro Hero Section" />
        </figure>
      </section>
      <section className="flex justify-between py-16">
        <div>
          <h3 className="uppercase font-alumni-sans font-bold text-2xl">my role</h3>
        ...
        <div>
          <h3 className="uppercase font-alumni-sans font-bold text-2xl">tech stack</h3>
        ...
        <div>
          <h3 className="uppercase font-alumni-sans font-bold text-2xl">date</h3>
          <p className="font-prompt-regular">January 2025</p>
        </div>
      </section>
      <section>
        <h3 className="uppercase text-xl font-alumni-sans font-bold pb-4">What I learned?</h3>
        <div className="flex justify-between  pb-8">
          <p className="uppercase font-alumni-sans font-bold text-2xl">organization</p>
        ...
        <div className="flex justify-between ">
          <p className="uppercase font-alumni-sans font-bold text-2xl">libraries</p>
        ...
        <div className="flex justify-between  pb-8">
          <p className="uppercase font-alumni-sans font-bold text-2xl">mongodb</p>
          <p className="font-prompt-regular w-[48rem]">
